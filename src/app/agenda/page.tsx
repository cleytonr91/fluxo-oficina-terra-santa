...
export default function AgendaPage() {
  ...
  const [itemKind, setItemKind] = useState<AgendaItemKind>("task");
  ...
  async function createItem(event: React.FormEvent<HTMLFormElement>) {
    ...
    const participantIds = kind === "meeting" ? selectedParticipantIds : [];
